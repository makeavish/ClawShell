...
native IOReport samples. It also writes
...
deadline, but scale, freshness/cadence, coverage, and fail-closed proof remain
required before promoting it to production provider proof.

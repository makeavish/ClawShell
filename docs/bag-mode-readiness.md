...
As of the May 14, 2026 local evidence, production Bag Mode remains blocked by
...
direct refresh of the same probe now records IOReport unit metadata and reports
...
and fail-closed proof before #25 can close.

...
current local artifact produced four helper-owned numeric ANS2/MSP samples, but
still needs scale validation, freshness/cadence, closed-bag coverage, and
fail-closed proof before #25 can close.

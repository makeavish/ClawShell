...
PROCESSINFO_TIMEOUT_SECONDS=${CLAWSHELL_TEMPERATURE_PROVIDER_PROCESSINFO_TIMEOUT_SECONDS:-5}
...
require_positive_integer "CLAWSHELL_TEMPERATURE_PROVIDER_PROCESSINFO_TIMEOUT_SECONDS" "$PROCESSINFO_TIMEOUT_SECONDS"
